...
public final class EntityMap {
	...
	private static void register() {
		...
		register("source_ametyst", null, null, UseableEntity.class);
		register("source_carbuncle", null, null, UseableEntity.class);
		register("source_emerald", null, null, UseableEntity.class);
		register("source_gold", null, null, UseableEntity.class);
		register("source_iron", null, null, UseableEntity.class);
		register("source_mithril", null, null, UseableEntity.class);
		register("source_obsidian", null, null, UseableEntity.class);
		register("source_salt", null, null, UseableEntity.class);
		register("source_sapphire", null, null, UseableEntity.class);
		register("source_silver", null, null, UseableEntity.class);
		register("source_sulfur", null, null, UseableEntity.class);
		register("wood_source", null, null, UseableEntity.class);
		// deprecated end
