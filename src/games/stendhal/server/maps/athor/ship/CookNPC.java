/* $Id: CookNPC.java,v 1.15 2011/02/16 00:06:02 bluelads99 Exp $ */
/***************************************************************************
...
public class CookNPC implements ZoneConfigurator  {
	...
	private void buildNPC(StendhalRPZone zone) {
		final SpeakerNPC npc = new SpeakerNPC("Laura") {
			...
			npc.setDescription ("Laura prowadzi kuchnię na statku. Porozmawiaj z nią jeśli zgłodniejesz lub będziesz spragniony.");
			zone.add(npc);	
