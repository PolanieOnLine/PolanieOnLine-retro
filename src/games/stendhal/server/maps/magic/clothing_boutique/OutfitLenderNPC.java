/* $Id: OutfitLenderNPC.java,v 1.20 2011/10/09 16:25:11 nhnb Exp $ */
/***************************************************************************
...
public class OutfitLenderNPC implements ZoneConfigurator {
	...
	private void initOutfits() {
		...
		// so true means we put on over
		  final Pair<Outfit, Boolean> JUMPSUIT = new Pair<Outfit, Boolean>(new Outfit(null, null, Integer.valueOf(62), null), true);
		  final Pair<Outfit, Boolean> DUNGAREES = new Pair<Outfit, Boolean>(new Outfit(null, null, Integer.valueOf(63), null), true);
		  final Pair<Outfit, Boolean> GREEN_DRESS = new Pair<Outfit, Boolean>(new Outfit(null, null,	Integer.valueOf(57), null), true);

		  final Pair<Outfit, Boolean> GOWN = new Pair<Outfit, Boolean>(new Outfit(null, null, Integer.valueOf(61), null), true);
		  final Pair<Outfit, Boolean> NOOB = new Pair<Outfit, Boolean>(new Outfit(null, null, Integer.valueOf(59), null), true);
		  final Pair<Outfit, Boolean> GLASSES = new Pair<Outfit, Boolean>(new Outfit(null, Integer.valueOf(36), null, null), true);
		  final Pair<Outfit, Boolean> GLASSES_2 = new Pair<Outfit, Boolean>(new Outfit(null, Integer.valueOf(26), null, null), true);
		  final Pair<Outfit, Boolean> HAT = new Pair<Outfit, Boolean>(new Outfit(Integer.valueOf(95), null, null, null), true);

		// these outfits must replace the current outfit (what's null simply isn't there)
		  final Pair<Outfit, Boolean> BUNNY = new Pair<Outfit, Boolean>(new Outfit(Integer.valueOf(00), Integer.valueOf(37), Integer.valueOf(64), Integer.valueOf(38)), false);
		  final Pair<Outfit, Boolean> HORSE = new Pair<Outfit, Boolean>(new Outfit(Integer.valueOf(00), Integer.valueOf(37), Integer.valueOf(00), Integer.valueOf(26)), false);
		  final Pair<Outfit, Boolean> GIRL_HORSE = new Pair<Outfit, Boolean>(new Outfit(Integer.valueOf(00), Integer.valueOf(37), Integer.valueOf(00), Integer.valueOf(25)), false);
		  final Pair<Outfit, Boolean> ALIEN = new Pair<Outfit, Boolean>(new Outfit(Integer.valueOf(00), Integer.valueOf(37), Integer.valueOf(00), Integer.valueOf(24)), false);
			...
			protected void createDialog() {
				class SpecialOutfitChangerBehaviour extends OutfitChangerBehaviour {
					...
					public boolean transactAgreedDeal(ItemParserResult res, final EventRaiser seller, final Player player) {
						...
						if (type) {
							if (player.getOutfit().getBase() > 15
									&& player.getOutfit().getBase() < 41) {
				...
				new OutfitChangerAdder().addOutfitChanger(this, behaviour,  Arrays.asList("hire", "wyporzycz"), false, false);
			}
		};
