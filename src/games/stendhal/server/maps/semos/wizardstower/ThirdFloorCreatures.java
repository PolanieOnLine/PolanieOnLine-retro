...
public class ThirdFloorCreatures implements ZoneConfigurator {
	...
	private void buildThirdFloor(final StendhalRPZone zone, final Map<String, String> attributes) {
		...
		final Creature creature1 = manager.getCreature("wysokie licho");
		final Creature creature2 = manager.getCreature("szkielet starszy");
		final Creature creature3 = manager.getCreature("upadły wysoki kapłan");
