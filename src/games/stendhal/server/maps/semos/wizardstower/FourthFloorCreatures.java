/* $Id: FourthFloorCreatures.java,v 1.6 2012/02/26 16:51:50 kiheru Exp $ */
/***************************************************************************
...
public class FourthFloorCreatures implements ZoneConfigurator {
	...
	private void buildFourthFloor(final StendhalRPZone zone, final Map<String, String> attributes) {
		...
		final Creature creature = manager.getCreature("żywioł wody");
		final Creature creature1 = manager.getCreature("żywioł lodu");
		final Creature creature2 = manager.getCreature("lodowy olbrzym");
		final Creature creature3 = manager.getCreature("lodowy golem");
