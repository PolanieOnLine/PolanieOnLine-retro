/* $Id: SixthFloorCreatures.java,v 1.6 2012/02/26 16:51:50 kiheru Exp $ */
/***************************************************************************
...
public class SixthFloorCreatures implements ZoneConfigurator {
	...
	private void buildSixthFloor(final StendhalRPZone zone, final Map<String, String> attributes) {
		...
		final Creature creature = manager.getCreature("mała wróżka");
		final Creature creature1 = manager.getCreature("pegaz");
		final Creature creature2 = manager.getCreature("jednorożec");
		final Creature creature3 = manager.getCreature("archanioł");
