/* $Id: RetireeNPC.java,v 1.23 2012/07/16 21:39:57 kymara Exp $ */
/***************************************************************************
	...
	private void buildNPC(StendhalRPZone zone) {
		final SpeakerNPC npc = new SpeakerNPC("Diogenes") {
			...
			public void createDialog() {
				...
				addHelp("Nie mogę Ci pomóc, ale ty możesz pomóc PolskaOnLine mówiąc znajomym i pomagając w rozwoju gry! Wejdź na http://www.gra.polskaonline.org i zobacz jak możesz nam pomóc!");
				addGoodbye();
		...
		npc.setDescription("Diogenes jest starszym mężczyzną, ale żwawym jak na swój wiek. Wygląda na przyjaznego i uczynnego.");
		zone.add(npc);
	}
