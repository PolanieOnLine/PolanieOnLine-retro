/* $Id: EdragonNPC.java,v 1.6 2010/09/19 02:28:01 eDragons Exp $ */
/***************************************************************************
	...
	private void buildNPC(final StendhalRPZone zone) {
		final SpeakerNPC npc = new SpeakerNPC("eDragon") {
			...
			protected void createDialog() {
				addGreeting(null, new SayTextWithPlayerNameAction("Witaj [name]! Mam nadzieję że nie jesteś szpiegiem w takim wypadku musiałbym cię pożreć."));
