/* $Id: MinerNPC.java,v 1.6 2010/09/19 02:28:01 Legolas Exp $ */
/***************************************************************************
...
public class MinerNPC implements ZoneConfigurator {
	...
	public void configureZone(final StendhalRPZone zone, final Map<String, String> attributes) {
		buildMiner(zone, attributes);
	}

	private void buildMiner(final StendhalRPZone zone, final Map<String, String> attributes) {
