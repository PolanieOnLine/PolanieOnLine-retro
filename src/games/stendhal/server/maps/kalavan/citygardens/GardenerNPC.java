/* $Id: GardenerNPC.java,v 1.26 2011/05/01 19:50:07 martinfuchs Exp $ */
/***************************************************************************
	...
	private void buildNPC(final StendhalRPZone zone, final Map<String, String> attributes) {
		final SpeakerNPC npc = new SpeakerNPC("Sue") {
			...
			protected void createDialog() {
				...
				addReply("kanapka", "Mmm.. Chciałbym z szynką i serem.");
				...
				addReply(Arrays.asList("tea", "cup of tea", "herbaty"), "Starsza Granny Graham może zaparzyć filiżankę herbaty. Ona jest tam w tej dużej chacie.");
