/* $Id: WaterForXhiphin.java,v 1.7 2011/11/13 17:15:18 kymara Exp $ */
/***************************************************************************
...
public class WaterForXhiphin extends AbstractQuest {
	...
	private void requestStep() {
		...
		npc.add(ConversationStates.ATTENDING,
				...
				ConversationStates.QUEST_OFFERED, 
				"Zaschło mi w gardle z tego gadania czy mógłbyś przynieść mi trochęwody?",
				null);	
		...
		npc.add(ConversationStates.QUEST_OFFERED,
				...
				null,
				ConversationStates.ATTENDING, 
				"Dziękuję! Naturalna świeża woda jest najlepsza. Rzece płynącej z Fado do Nal'wor wodę zapewnia źródło.",
