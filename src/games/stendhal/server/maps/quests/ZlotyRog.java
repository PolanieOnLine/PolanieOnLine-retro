/* $Id: ZlotaCiupagaWas.java,v 1.51 2011/12/11 15:21:23 Legolas Exp $ */
/***************************************************************************
...
public class ZlotyRog extends AbstractQuest {
				...
				public void fire(final Player player, final Sentence sentence, final EventRaiser raiser) {
					if (player.isQuestCompleted(WEAPONS_COLLECTOR_QUEST_SLOT)) {
						if(player.getLevel() >= 200) {
							...
							npc.say("Twój stan społeczny jest zbyt niski aby podjąć te zadanie. Wróć gdy zdobędziesz 200 lvl.");
							raiser.setCurrentState(ConversationStates.ATTENDING);
						}
					} else {
	...
	private void step_2() {
		...
		npc.add(ConversationStates.ATTENDING, Arrays.asList("rzeczy", "przedmioty", "nagroda", "róg", "przypomnij"),
