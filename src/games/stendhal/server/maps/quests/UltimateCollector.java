/* $Id: UltimateCollector.java,v 1.26 2012/04/19 18:26:42 kymara Exp $ */
/***************************************************************************
...
public class UltimateCollector extends AbstractQuest {
	...
	private void requestItem() {
		...
		items.put("kosa czarna",1); // 3918 (pretty sure this is rarer now but a lot of old ones about to buy)
