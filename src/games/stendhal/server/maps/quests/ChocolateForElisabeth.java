/* $Id: ChocolateForElisabeth.java,v 1.9 2012/04/19 18:27:49 kymara Exp $ */
/***************************************************************************
...
public class ChocolateForElisabeth extends AbstractQuest {
	...
	private void chocolateStep() {
		...
		npc.addReply(Arrays.asList("chocolate", "czekolada", "czekolady"), "Moja mam powiedziała mi, że czekoladę można znaleść w szkole zabójców, która jest #niebezpieczna. Powiedziała mi także, że ktoś sprzedaje ją w Ados...");
		...
		npc.add(ConversationStates.ATTENDING,
				...
				ConversationStates.QUEST_OFFERED, 
				"Mam ndzieję, że jeżeli poproszę o następną tabliczkę czekolady to nie będę zbyt zachłanna. Czy możesz zdobyć następną?",
				null);	
