/* $Id: MeetZynn.java,v 1.30 2011/11/13 17:14:15 kymara Exp $ */
/***************************************************************************
	...
	private void step_1() {
		...
		npc
				.addReply(
						...
						"Mapę PolskaOnLine możesz zobaczyć na stronie #http://www.gra.polskaonline.org/strona/kraina-pras%C5%82owia%C5%84ska jeżeli chcesz. Nie spodziewaj się, że będą na niej oznaczone potwory!");

		npc
				.addReply(
						"SPPOL",
						"SPPOL znaczy System Pozycjonowania PolskaOnLine. Możesz zapytać #Io w Świątyni o szczegóły jak to działa. W zasadzie pozwala Tobie ustalić dokładną lokację siebie lub przyjaciela.");
