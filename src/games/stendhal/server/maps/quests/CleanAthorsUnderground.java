/* $Id: CleanAthorsUnderground.java,v 1.8 2012/07/07 21:52:50 bluelads99 Exp $ */
/***************************************************************************
...
public class CleanAthorsUnderground extends AbstractQuest {
	...
	private void step_1() {
		...
		npc.add(ConversationStates.ATTENDING,
				...
				ConversationStates.QUEST_OFFERED,
				"Te #potwory wróciły od tamtego czasu, gdy nam pomogłeś. Możesz ców nam pomóc?",
				null);
	...
	private void step_3() {
		...
		final List<ChatAction> actions = new LinkedList<ChatAction>();
	    actions.add(new EquipItemAction("duży eliksir", 10));
