/* $Id: MeetKetteh.java,v 1.49 2012/09/29 15:31:00 kymara Exp $ */
/***************************************************************************
...
public class MeetKetteh extends AbstractQuest {
	...
	private void step1() {
		...
		npc.add(ConversationStates.IDLE, 
				...
				null,
				new MultipleActions(
						new SayTextWithPlayerNameAction("Witaj ponownie [name]. Tak się cieszę, że masz na sobie jakieś ubrania. Teraz możemy kontynuować lekcję o #manierach. Czy wiesz, że jak ktoś coś powie na niebiesko to grzecznie jest to powtórzyć? Powtórz za mną: #maniery."),
		...
		npc.add(ConversationStates.IDLE, 
				...
				null,
				new MultipleActions(
						new SayTextWithPlayerNameAction("Witaj [name] miło cię poznać. Mamy coś wspólnego - dobre maniery . Czy wiedziałeś, że jeżeli ktoś powie słowo na #niebiesko to grzecznie będzie powtórzyć je danej osobie. Powtarzaj za mną: #maniery."),
						new SetQuestAction(QUEST_SLOT, "seen")));
		...
		npc.add(ConversationStates.IDLE, 
				...
				ConversationStates.ATTENDING, 
				null,
				new SayTextWithPlayerNameAction("Witaj ponownie [name]."));
		...
		npc.add(ConversationStates.IDLE, 
				...
				ConversationStates.ATTENDING, 
				null,
				new SayTextWithPlayerNameAction("Witaj ponownie [name]. Mam nadzieję, że jesteś tutaj, aby kontynuować lekcję o #manierach."));
