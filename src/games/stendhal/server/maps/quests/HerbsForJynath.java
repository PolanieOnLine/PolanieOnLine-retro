...
public class HerbsForJynath extends AbstractQuest {
    ...
    List<String> NEW_QUEST_MESSAGES = ConversationPhrases.combine(ConversationPhrases.QUEST_MESSAGES, "ziół");
    List<String> NEW_QUEST_MESSAGES_2 = ConversationPhrases.combine(ConversationPhrases.QUEST_MESSAGES, "zioła");
