...
public class UseAction implements ActionListener {
	...
	private boolean isInJailZone(final Player player, final RPObject object) {
		...
		if ((object instanceof Item) && (zonename.endsWith("_jail")) || (zonename.endsWith("_afterlife"))) {
			player.sendPrivateText("Ze względów bezpieczeństwa przedmioty nie mogą być tutaj używane.");
			return true;
		}
