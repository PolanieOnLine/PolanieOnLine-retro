...
public class AskForSupportAction  implements ActionListener {
	...
	public void onAction(final Player player, final RPAction action) {
		...
		if ("".equals(text)) {
			player.sendPrivateText("Użyj /support <tutaj twoja wiadomość>");
			return;
		}
		...
		player.sendPrivateText(NotificationType.SUPPORT, "Zapytałeś administratorów: "
				+ action.get(TEXT)
				+ "\nMoże zająć to trochę czasu nim ktoś odpowie na twoje pytanie.");
