/* $Id: PlayerList.java,v 1.17 2011/01/07 22:46:54 nhnb Exp $ */
/***************************************************************************
...
public class PlayerList {
	...
	public void add(final Player player) {
		...
		if (playerName != null) {
			...
			throw new IllegalArgumentException("nie można dodać wojownika bez podania jego imienia");
		}
	}
	...
	public boolean remove(final Player player) {
		...
		if (playerName != null) {
			...
			throw new IllegalArgumentException("nie można usunąć wojownika bez podania jego imienia:");
		}
	}
