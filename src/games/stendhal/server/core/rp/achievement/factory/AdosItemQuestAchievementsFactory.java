...
public class AdosItemQuestAchievementsFactory extends AbstractAchievementFactory {
	...
	public Collection<Achievement> createAchievements() {
		...
		achievements.add(createAchievement("quest.special.daily_item.0010", "Pomocnik Ados", "Ukończył codzinne zadanie na przedmiot 10 razy",
												Achievement.EASY_BASE_SCORE, true, new QuestStateGreaterThanCondition("daily_item", 2, 9)));
		achievements.add(createAchievement("quest.special.daily_item.0050", "Dostawca Ados", "Ukończył codzinne zadanie na przedmiot 50 razy",
												Achievement.EASY_BASE_SCORE, true, new QuestStateGreaterThanCondition("daily_item", 2, 49)));
		achievements.add(createAchievement("quest.special.daily_item.0100", "Główny Dostawca Ados", "Ukończył codzinne zadanie na przedmiot 100 razy",
												Achievement.MEDIUM_BASE_SCORE, true, new QuestStateGreaterThanCondition("daily_item", 2, 99)));
		achievements.add(createAchievement("quest.special.daily_item.0250", "Magazynier Ados", "Ukończył codzinne zadanie na przedmiot 250 razy",
												Achievement.MEDIUM_BASE_SCORE, true, new QuestStateGreaterThanCondition("daily_item", 2, 249)));
		achievements.add(createAchievement("quest.special.daily_item.0500", "Skarbnik Ados", "Ukończył codzinne zadanie na przedmiot 500 razy",
