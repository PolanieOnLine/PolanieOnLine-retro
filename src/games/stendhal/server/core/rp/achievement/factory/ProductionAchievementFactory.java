...
public class ProductionAchievementFactory extends AbstractAchievementFactory {
	...
	public Collection<Achievement> createAchievements() {
		...
		achievements.add(createAchievement("production.class.resource", "Alchemik", "Wyprodukował po 5 rodzai każdego cennego metalu i zasobów",
				Achievement.HARD_BASE_SCORE, true,
				new PlayerProducedNumberOfItemsCondition(5, resources)));
		
		achievements.add(createAchievement("production.flour.1000", "Asystent Jenny", "Zrobił 100 mąk",
