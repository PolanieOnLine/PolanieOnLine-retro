 ...
 * @author KarajuSs
 */
public class SourcePlatinum extends SourceEntity {
	private final static String sourceClass = "source_platinum";
	...
	/**
	 * Create a platinum source.
	 */
	public SourcePlatinum() {
		this("ruda platyny");
	}
	 ...
	 */
	public SourcePlatinum(final String itemName) {
