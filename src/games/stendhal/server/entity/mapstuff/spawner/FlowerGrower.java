/* $Id: FlowerGrower.java,v 1.25 2011/04/02 15:44:19 kymara Exp $ */
/***************************************************************************
...
public class FlowerGrower extends VegetableGrower {
	...
	private final String[] description = {
			"Widzisz nasiona, które przed chwilą zostały zasadzone.",
			"Coś zaczyna kiełkować spod ziemi.",
			"Tutaj rośnie roślina i jak widzisz ma już liście.",
			"Tutaj rośnie " + Grammar.fullForm(getVegetableName())
					+ " i jest już prawie dojrzała.",
			"Widzisz wyrośniętą " + Grammar.fullForm(getVegetableName())
					+ " gotowa, aby wyciągnąć ją z ziemi." };
	 ...
	 *            the item to grow
	 */
	public FlowerGrower(final RPObject object, final String itemname, final String itemview) {
		super(object, itemname, itemview, MAX_RIPENESS, GROW_TIME_TURNS);
		store();
	}
