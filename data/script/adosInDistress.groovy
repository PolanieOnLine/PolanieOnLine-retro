...
public class Friends implements TurnListener {
	...
	public void onTurnReached(int currentTurn, String message) {
		...
		switch (turnCounter) {
			...
			case 0:
				shout("Katinka krzyczy: Pomocy. Dwa Orki zbli¿aj¹ siê do naszego schroniska dla dzikich zwierz¹t");
				wait = 5 * 3;
				break;

			case 1:
				shout("Dowódca ¿o³nierzy krzyczy: Uspokój siê Katinka.");
				break;

			case 2:
				shout("Dowódca ¿o³nierzy krzyczy: Wyœlê jednego z moich najlepszych ¿o³nierzy zwanego Marcus, aby pomóg³ Tobie.");
				wait = 60 * 3;
				break;
			...
			case 4:
				shout("Marcus krzyczy: Oni byli tylko zwiadowcami du¿ej gromady Orków Wojowników.");
				break;

			case 5:
				shout("Marcus krzyczy: Potrzebujemy posi³ków w ci¹gu 10 minut.");
				wait = 10 * 3;
				break;

			case 6:
				shout("Io Flotto krzyczy: W po³udniowo-zachodniej czêœci Semos utworzy³am portal ko³o Carmen.");
				break;

			case 7:
				shout("Io Flotto krzyczy: Mo¿esz u¿yæ go, aby dostaæ siê na czas do schroniska dla zwierz¹t w Ados.");
				wait = 120 * 3;
				break;

			case 8:
				shout("Katinka krzyczy: Aaa! Zjedli nasze dziki. Pomó¿ nam!");
				// shout("Dr. Feelgood krzyczy: Pomocy! Pomó¿ nam! Schronisko dla zwierz¹t w Ados jest mocno atakowane przez gromadê Orków Wojowników.");
				wait = 600 * 3;
				break;
